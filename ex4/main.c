...
void sort(int number, int tab[]);                    // sorts elements of array in numerical order
...
* @param char *argv[] - array of pointers to Strings containing each argument
*                       (index 0 is always program name)
* @return int         - exit code, 0 == successful program execution and 1 ==
*                       program termination with error
**/
int main (void) {
    ...
    // print resulting first occurrence (-1 signifies number not present in String)    
...
/**   
* Determine if number exists in an array and at what index. Note that the first
...
* @return int       - index of first occurrence of number in array (-1 if
...
* 
* @function sort
* @param int number - the number of elements in the array
...
void swapElements(int* a, int* b) { 
    ...
    // declare temporary storage of an int
    int tempChar; 
